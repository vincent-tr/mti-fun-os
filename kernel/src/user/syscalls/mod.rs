...
pub fn init() {
    ...
    register_syscall(SyscallNumber::ProcessMInfo, process::minfo);
    ...
    register_syscall(SyscallNumber::ThreadGetName, thread::get_name);
    ...
    register_syscall(SyscallNumber::IrqCreate, irq::create);
